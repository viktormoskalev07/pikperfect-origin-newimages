...
<section class="section-text section-text_white">
  <div class="section-text__container section-text_big-container">
    ...
    <div class="section-text__content">
      <p>Ein Verlobungsfotobuch zu gestalten ist nicht nur ein besonderes Verlobungsgeschenk für den Partner, es ist auch ideal als Geschenk für Eltern und Schwiegereltern, um eure Liebesgeschichte zu teilen. Unsere erfahrenen Fotobuch Designer gestalten ein wunderschönes <a href="<?php echo $this->languageUrl('static-photo-books-') ?>" class="link" target="_blank">Fotobuch Erinnerungsstück</a> entsprechend eures Geschmacks und eures Budgets.</p>
